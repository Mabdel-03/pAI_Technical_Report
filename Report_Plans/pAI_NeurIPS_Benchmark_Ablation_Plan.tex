...
C5 & Councils as quality mechanisms & Sandboxed cross-model counsel plus persona councils covering rigor, novelty, practicality, narrative, and empirical grounding. & Council ablation on proposal, experiment, theory, and writeup tasks; judge and human-review deltas. \\
...
\begin{enumerate}
  ...
  \item Route each benchmark through the narrowest \pai{} subgraph that corresponds to the benchmarked capability.
...
\midrule
\endhead
Full \pai{} & All typed gates, claim graph, councils, coupled tracks, reviewer routing, traceability, and human steering enabled. & Reference condition for all paired comparisons. & \core{} \\
...
No Councils & Disable persona council and cross-model counsel; reallocate budget to main agent. & Do councils improve novelty, rigor, empirical grounding, and narrative quality? & \core{} \\
...
Single-Agent Baseline & One ReAct-style agent receives same tools and total budget but no specialized subgraphs. & Is \pai{}'s graph composition better than a strong single-agent scaffold? & \core{} \\
